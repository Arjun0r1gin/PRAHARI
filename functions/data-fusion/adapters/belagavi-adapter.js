/**
 * @fileoverview Belagavi District Adapter.
 *
 * Station → format mapping:
 *   belagavi-rural → DD-MM-YYYY    "Suspect Name"
 *   camp           → ISO 8601      "Offender Name"
 *   apmc           → Unix epoch    "Accused"
 *   kakati         → MM/DD/YYYY    "Person of Interest"
 */
...
const CRIMINAL_FIELD = {
  'belagavi-rural': 'Suspect Name',
  'camp':           'Offender Name',
  'apmc':           'Accused',
  'kakati':         'Person of Interest',
};

const DATE_TIME_STATIONS = new Set(['belagavi-rural', 'kakati']);

class BelagaviAdapter extends BaseAdapter {
...
module.exports = BelagaviAdapter;
