/**
 * @fileoverview Mangaluru District Adapter.
 *
 * Station → format mapping:
 *   mangalore-north → DD-MM-YYYY    "Suspect Name"
 *   mangalore-south → ISO 8601      "Offender Name"
 *   mangalore-east  → Unix epoch    "Accused"
 *   panambur        → MM/DD/YYYY    "Person of Interest"
 */
...
const CRIMINAL_FIELD = {
  'mangalore-north': 'Suspect Name',
  'mangalore-south': 'Offender Name',
  'mangalore-east':  'Accused',
  'panambur':        'Person of Interest',
};

const DATE_TIME_STATIONS = new Set(['mangalore-north', 'panambur']);

class MangaluruAdapter extends BaseAdapter {
...
module.exports = MangaluruAdapter;
