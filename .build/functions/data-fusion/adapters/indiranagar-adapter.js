/**
 * @fileoverview Indiranagar Police Station Adapter.
 *
 * Date format : MM/DD/YYYY with separate `date` and `time` columns in fir.csv
 *               and `timestamp` (MM/DD/YYYY HH:MM) in cctv.csv
 * Criminal field : "Person of Interest"
 * Wanted date  : MM/DD/YYYY string in date_wanted_since
 */
...
class IndiranagarAdapter extends BaseAdapter {
    ...
    switch (fileType) {
      case 'fir':
        return {
          ...
          // Indiranagar has separate date + time columns
      ...
      case 'criminals':
        return {
          ...
          // Indiranagar uses "Person of Interest"
          person_name: row['Person of Interest'] || null,
...
module.exports = IndiranagarAdapter;
