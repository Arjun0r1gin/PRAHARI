/**
 * @fileoverview HAL Police Station Adapter.
 *
 * Date format : ISO 8601 (timestamp column)
 * Criminal field : "Offender Name" (capital letters, space — intentional inconsistency)
...
class HalAdapter extends BaseAdapter {
    ...
    switch (fileType) {
      ...
      case 'criminals':
        return {
          ...
          // HAL uses "Offender Name" — normalised here
          person_name: row['Offender Name'] || null,
