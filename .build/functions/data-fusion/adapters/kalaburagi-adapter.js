/**
 * @fileoverview Kalaburagi District Adapter.
 *
 * Station → format mapping:
 *   ashok-nagar   → DD-MM-YYYY    "Suspect Name"
 *   brahmapur     → ISO 8601      "Offender Name"
 *   station-bazar → Unix epoch    "Accused"
 *   roza          → MM/DD/YYYY    "Person of Interest"
 */
...
const CRIMINAL_FIELD = {
  'ashok-nagar':   'Suspect Name',
  'brahmapur':     'Offender Name',
  'station-bazar': 'Accused',
  'roza':          'Person of Interest',
};

const DATE_TIME_STATIONS = new Set(['ashok-nagar', 'roza']);

class KalaburagAdapter extends BaseAdapter {
...
module.exports = KalaburagAdapter;
